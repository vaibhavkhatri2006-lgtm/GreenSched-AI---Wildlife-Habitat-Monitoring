    ...
    <div className="flex h-full gap-6 max-w-7xl mx-auto">
      ...
      <div className="w-80 flex flex-col gap-4">
        <div className="glass-panel p-5 rounded-xl border border-slate-800">
          <h2 className="font-heading font-semibold text-2xl text-[#F4C430] mb-4 tracking-wider uppercase">Define Monitoring Area</h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                type="text" 
                className="w-full bg-[#0a0f0d] border border-white/10 rounded-md px-3 py-3 text-sm text-slate-200 outline-none focus:border-[#F4C430] focus:ring-1 focus:ring-[#F4C430]/50 transition-all"
            ...
            <div className="pt-2 border-t border-slate-800">
              ...
              {status && <p className="text-xs mt-3 text-center text-[#94A8A0] font-medium">{status}</p>}
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Map */}
      <div className="flex-1 glass-panel rounded-xl border border-slate-800 overflow-hidden relative">
        ...
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-[1000] bg-slate-900/90 backdrop-blur-md px-4 py-2 rounded-full border border-[#F4C430]/20 shadow-lg flex items-center gap-3">
          <span className="text-xs font-medium text-[#F4C430] uppercase tracking-wider">Click Map to Generate AOI</span>
        </div>
        <div className="absolute bottom-4 right-4 z-[1000] bg-slate-900/90 backdrop-blur px-4 py-3 rounded-lg border border-slate-700 shadow-lg">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-300">Selected Area of Interest</span>
            </div>
          </div>
        </div>
        <MapContainer center={[-2.3333, 34.8333]} zoom={5} className="h-full w-full bg-slate-900 z-0 cursor-crosshair">
          <TileLayer
